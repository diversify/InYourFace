 ...
 */
public class NetworkConfirm extends AsyncTask<String, Void, Boolean> {
    ...
    protected Boolean doInBackground(String... name) {
        ...
        HttpPost httppost = new HttpPost("https://inyourface.herokuapp.com/songservice/confirm");
        ...
        try {
            ...
            if(message.equals("Song confirmed")){
                return true;
            }
